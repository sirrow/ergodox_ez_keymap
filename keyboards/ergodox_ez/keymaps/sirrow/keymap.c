...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        LGUI_T(KC_Z),         LALT_T(KC_X),   LSFT_T(KC_C),   LCTL_T(KC_V),   KC_B,   KC_NO,
        MO(SYMB),KC_NO,      KC_LGUI,  KC_LALT,MO(BRCT),
                                              KC_LGUI, KC_APP,
                                                              KC_NO,
	...
	KC_NO   ,    KC_N,   LCTL_T(KC_M),  LSFT_T(KC_COMM),LALT_T(KC_DOT), LGUI_T(KC_SLSH),          KC_MINS,
